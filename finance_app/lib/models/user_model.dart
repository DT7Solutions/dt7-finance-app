class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    ...
    return UserModel(
      ...
      role: json['role'] ?? (profile is Map ? profile['role'] : null) ?? 'EMPLOYEE',
      department: profile['department'] ?? 'Sales Department',
      employeeId: (profile is Map ? profile['employee_id'] : null) ?? json['employee_id'] ?? 'DT7EMP${(json['id'] ?? 0).toString().padLeft(3, '0')}',
